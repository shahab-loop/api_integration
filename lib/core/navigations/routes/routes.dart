...
class Routes {
  ...
  static final String signupScreen = SignupScreen.routeName;
  static final String otpVerification = OtpVerification.routeName;
  static final String homeScreen = HomeScreen.routeName;
  static final String uploadScreen = UploadScreen.routeName;
}